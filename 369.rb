# Background
# One common way for software specifications such as HTML to specify colors 
# is with a hexadecimal string. For instance the color aquamarine is represented 
# by the string "#7FFFD4". Here's how the string breaks down:
# 
# The first character is always "#".
# 
# The second and third character are the red channel value, represented as a hexadecimal 
# value between 00 and FF. In this example, the red channel value is 127, which in hexadecimal is 7F.
# 
...
# blue channel values of a color, find the hex string for that color. You may use 
# anything built into your programming language, such as for base conversion, but you can also do it manually.
# 
# Examples
# 
...
# Given a list of hex color strings, produce the hex color string you 
# get from averaging their RGB values together. You'll need to round channel values to integers.
# 
# blend({"#000000", "#778899"}) => "#3C444C"
# blend({"#E6E6FA", "#FF69B4", "#B0C4DE"}) => "#DCB1D9"
# (This is not actually the best way to blend two hex colors: to do 
#   it properly you need gamma correction. But we'll leave that for another time!)
...
puts hexcolor(127, 255, 212) == "#7FFFD4"
puts hexcolor(255, 99, 71) == "#FF6347" 
puts hexcolor(184, 134, 11) == "#B8860B"
puts hexcolor(189, 183, 107) == "#BDB76B"
puts hexcolor(0, 0, 205) == "#0000CD"
puts blend("#000000", "#778899") == "#3B444C"
puts blend("#E6E6FA", "#FF69B4", "#B0C4DE") == "#DCB1D9"
